...
class Snapshot : public ICanvas, public CDC
{
	rect_t _clip;
	CBitmap _bmp;

	void privateDrawString(const rect_t &rect, const rect_t &box, color_t fore, color_t back, const Font& font, align_t align, const string_t &text);
public:
	Snapshot(HWND hWnd);
