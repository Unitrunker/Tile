...
class Canvas : public ICanvas, public CPaintDC
{
	rect_t _clip;
public:
	Canvas(CWnd *);
	...
	virtual void DrawString(const rect_t &rect, const rect_t &box, color_t fore, color_t back, const Tiles::Font &font, align_t align, const string_t &text);
	/// <param name="rect">bounding rectangle</param>
	/// <param name="fore">foreground text color</param>
	/// <param name="back">background color</param>
	/// <param name="font">font including face, point size, and style.</param>
	...
	virtual void DrawEditString(const rect_t &rect, const rect_t &box, color_t fore, color_t back, const Tiles::Font &font, align_t align, const string_t &text, size_t cursor);
    /// <param name="rect">bounding rectangle</param>
